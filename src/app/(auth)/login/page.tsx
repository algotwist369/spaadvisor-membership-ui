...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-6 bg-[radial-gradient(circle_at_top_right,_var(--tw-gradient-stops))] from-primary/5 via-white to-white">
        ...
        <Card className="p-8">
          ...
          {step === 'DETAILS' ? (
            ...
            <form onSubmit={handleVerifyOtp} className="space-y-6">
              <div className="space-y-2">
                <label className="text-sm font-medium text-secondary-700 ml-1">One-Time Password</label>
                <div className="relative">
